...
class APIClient {
    ...
    /**
     * Sendet eine Chat-Nachricht an die KI (Enhanced Version)
     * @param {string} message - Die Benutzer-Nachricht
     * @param {string} currentHTML - Aktueller HTML-Code
     * @param {Object} preferences - User-Präferenzen
     * @param {string} sessionId - Session-ID
     * @returns {Promise<Object>} API-Response
     */
    async sendChatMessage(message, currentHTML = '', preferences = {}, sessionId = null) {
        try {
            const requestData = {
                message: message.trim(),
                currentHTML,
                preferences: {
                    websiteType: preferences.websiteType || null,
    ...
    /**
     * Validiert API-Response auf Vollständigkeit
     * @param {Object} data - API-Response
     * @returns {Object} Validierte Response mit Fallback-Werten
     */
    validateResponse(data) {
        return {
            success: data.success || false,
            html: data.html || '',
            message: data.message || 'Website generiert',
            intent: data.intent || {},
