...
function Pricing() {
  ...
  return (
    <section id="pricing" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black/20 to-transparent">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="glassmorphism p-6">
              ...
              <p className="text-gray-300">We offer a 30-day money-back guarantee on all paid plans. No questions asked.</p>
            </div>
            <div className="glassmorphism p-6">
